...
const AlertItem: React.FC<AlertItemProps> = ({ title, content, type, onClick }) => {
  ...
  return (
    <div
      className={`flex w-full border-l-6 ${getNotificationStyles(type)} px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9`}
      onClick={onClick}
    >
