...
//       fetch('/api/admin/stats') // Указываем правильный путь для API
//         .then((response) => {
//           if (!response.ok) {
...
//   const totalCandidates = getDataForCard('candidates', 'totalCandidates');
//   const totalPartners = getDataForCard('partners', 'totalPartners');
//   const totalUsers = getDataForCard('tasks', 'totalUsers');
...
//             >
//               <span className="text-md font-semibold">{useCountUp(totalCandidates)}</span>
//             </motion.div>
//           </CardDataStats>
...
//               transition={{ duration: 0.5 }}
//             >
//               <span className='text-sm font-semibold'>{useCountUp(totalPartners)}</span>
//             </motion.div>
//           </CardDataStats>
...
//               transition={{ duration: 0.5 }}
//             />
//             <span className='text-sm font-semibold'>{useCountUp(totalUsers)}</span>
//           </CardDataStats>
//         </div>
//       </div>
//     </div>
